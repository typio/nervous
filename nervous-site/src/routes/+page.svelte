...
<div class="max-w-5xl mx-auto">
  <p class="px-4 pt-4 text-red-900">
    Demonstrations of the <a
      href="https://github.com/typio/nervous"
  ...
  <div class="flex flex-wrap">
    ...
    <div class=" rounded shadow  p-6 mt-4 mx-4 w-screen sm:w-auto max-w-sm">
      <a
        href="/XOR"
        class=" font-medium text-red-500 hover:border-b-4 border-red-500">XOR</a
      >
      <p class="text-red-900 text-sm">Planned for future...</p>
    </div>
  </div>
</div>
