...
<body class="text-slate-700 ">
    ...
    >
        ...
        <div class="mt-8 indent-8 space-y-4">
            ...
            <p>
                In the linear classifier, the input variables <Katex
                    math="(x)"
                /> are multiplied by a matrix of weights <Katex math="(W)" />,
                and a vector <Katex math="(b)" /> is added to the product. This produces
                a set of weighted input values that represent the relative importance
                of each input variable in predicting the species of the flower. The
                index of the largest value in the resultant vector is the predicted
                species of the flower <Katex math="(y)" />. Initially, <Katex
                    math="W"
                /> and <Katex math="b" /> are assigned random values, but the neural
                network learns by adjusting these values in a way that minimizes
                future error.
            </p>
            <p>
